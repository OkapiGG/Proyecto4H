...
import controlador.ControladorMenuArrastre;

/**
 *
 * @author ep712
 */
public class MenuArrastre extends javax.swing.JFrame {

    /**
     * Creates new form MenuJuego
     */
    ControladorMenuArrastre objControladorMenuJuego;
    public MenuArrastre() {
        initComponents();
        this.setLocationRelativeTo(null);
        objControladorMenuJuego = new ControladorMenuArrastre(this);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuArrastre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
