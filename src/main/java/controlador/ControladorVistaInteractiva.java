...
public class ControladorVistaInteractiva extends ControladorClaseDragDrop {

    private VistaCartaInteractiva vista;
    ...
    public ControladorVistaInteractiva(
            VistaCartaInteractiva vista,
            int indicePalabra,
